...
hold off
f1_name = strcat('Ex4_differential_correction_mu=',num2str(mu),'_x0=',num2str(x0(1)),'_z0=',num2str(x0(3)),'_ydot0=',num2str(x0(5)),'_t0=',num2str(t0));
f1_name = strrep(f1_name,'.',',');
save_fig(f1,f1_name,view_angle);
...
hold off
f2_name = strcat('Ex4_monodromy_mu=',num2str(mu),'_x0=',num2str(x0(1)),'_z0=',num2str(x0(3)),'_ydot0=',num2str(x0(5)),'_t0=',num2str(t0));
...
ylim([-1.5 1.5]);
hold off
f3_name = strcat('Ex4_monodromy_origin_mu=',num2str(mu),'_x0=',num2str(x0(1)),'_z0=',num2str(x0(3)),'_ydot0=',num2str(x0(5)),'_t0=',num2str(t0));
f3_name = strrep(f3_name,'.',',');
save_fig(f2,f3_name,[0 90]);
